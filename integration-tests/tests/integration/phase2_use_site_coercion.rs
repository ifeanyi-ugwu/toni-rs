...
//! of that plumbing:
//!   1. a `#[derive(Injectable)]` guard with its own injected dependency resolves by type;
...
// The guard: `#[derive(Injectable)]` + a normal `impl Guard<HttpContext>`. No `#[guard]` marker,
