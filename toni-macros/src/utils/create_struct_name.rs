...
pub fn create_struct_name(ref_name: &str, method_name: &Ident) -> Result<Ident> {
    ...
    Ok(Ident::new(clean_name, Span::call_site()))
}

pub fn create_field_struct_name(ref_name: &str, field_name: &Ident) -> Result<Ident> {
