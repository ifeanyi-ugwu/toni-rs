...
pub fn generate_manager(
    ...
    quote! {
        ...
        impl ::toni::traits_helpers::Controller for #manager_struct_name {
            fn get_all_controllers(&self, dependencies: &::toni::FxHashMap<String, ::std::sync::Arc<Box<dyn ::toni::traits_helpers::ProviderTrait>>>) -> ::toni::FxHashMap<String, ::std::sync::Arc<Box<dyn ::toni::traits_helpers::ControllerTrait>>> {
